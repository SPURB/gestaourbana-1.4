<?php
/*
Template Name: Centro Dialogo Aberto
*/
?>
...
<div class="wrapper page-dialogo">
  <?php the_content(); ?>
    ...
    <div class="sessoes">
        ...
        <p class="left jornal">transformadas em projetos piloto. Provisoriamente, serão construídos para serem testados pelo uso efetivo e ativo da população. Testar projetos em escala 1:1 não é usual em urbanismo. O usual é se elaborar reduzidas maquetes, que acostumamos a olhar por cima, de forma impessoal e impenetrável.</p>
        <p class="left">Vamos ensaiar agora uma outra forma possível de se fazer. Vamos poder vivenciar as transformações imaginadas. E então torná-las permanentes.  Até que no futuro outras formas de uso ainda inimaginadas as ressignifiquem, mais uma vez, de novo.</p>
